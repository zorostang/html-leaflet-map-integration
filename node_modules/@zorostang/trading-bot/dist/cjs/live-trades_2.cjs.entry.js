...
const __chunk_1 = require('./chunk-e9b0aa8c.js');
...
class LiveTrades {
    ...
    render() {
        if (!this.lastTrade)
            return null;
        return __chunk_1.h("div", null, this.instrument, " is trading at: ", __chunk_1.h("span", { style: this.style() }, this.lastTrade.price));
    }
...
class MyComponent {
    ...
    render() {
        return __chunk_1.h("div", null, "This is a demonstration of a stencil.js component ", this.getText());
    }
    static get style() { return ""; }
}

exports.live_trades = LiveTrades;
